...
const GatePuzzle2 = ({ onSolve, notation }: Props) => {
  ...
  return (
    <div className="min-h-screen bg-black text-lime-300 font-mono flex flex-col items-center justify-center p-8 tracking-wide">
      <h1 className="text-2xl md:text-3xl font-bold mb-6 border-b border-lime-500 pb-2">
        Logic Puzzle 2: OR Gate
      </h1>

      <div className="mb-6 text-center max-w-xl">
        <p className="mb-2">To unlock the gate, at least one of Input A or Input B must be <strong>true</strong>.</p>
        <p>The gate uses an <code className="text-lime-400">OR</code> logic gate.</p>
      </div>
